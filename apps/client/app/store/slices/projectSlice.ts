...
const calculateTotalDuration = (mediaFiles: MediaFile[], textElements: TextElement[]): number => {
...
const projectStateSlice = createSlice({
  ...
  reducers: {
    ...
    updateTextElement: (state, action: PayloadAction<{ id: string; updates: TextElement }>) => {
